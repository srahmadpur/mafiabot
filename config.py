TOKEN = '900555854:AAGl6LXOB_ID82M8bFepSV7eUnGbzMI0Lk8'  # Learn how to get one on https://core.telegram.org/bots#6-botfather
ADMIN_ID = 743596591 #changed
SKIP_PENDING = False  # Skip pending updates on bot startup
PLAYERS_COUNT_TO_START = 3  # Minimal quantity of players that is required to start mafia game
...
MONGO_SERVER = "mongodb+srv://admin:admin@cluster0-7ygip.mongodb.net/test?retryWrites=true&w=majority"
